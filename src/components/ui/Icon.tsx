...
export function Icon({ name, size = 24, className = "" }: IconProps) {
  ...
  const icons: Record<string, string[] | string> = {
    ...
    globe: "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zm0-2a8 8 0 100-16 8 8 0 000 16z M12 15a3 3 0 110-6 3 3 0 010 6zm-1-3h2v2h-2v-2z",
  ...
  // If icon doesn't exist, render nothing
  if (!paths) {
